    ...
    <html lang="tr">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        ...
        <div className="fixed bottom-8 right-8 z-50 flex flex-col items-center">
          <a href={`https://api.whatsapp.com/send?phone=+905331625539&text=${encodeURIComponent("Merhaba, Boş odanız var mı?")}`} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full flex items-center justify-center bg-[#25D366] text-white shadow-lg hover:opacity-90 transition-colors">
        ...
        <div className="fixed bottom-24 right-8 z-50 flex flex-col items-center rounded-full">
          <a href="https://arabacilarpansiyonotel.sahibinden.com" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full flex items-center justify-center  text-white shadow-lg  transition-colors">
