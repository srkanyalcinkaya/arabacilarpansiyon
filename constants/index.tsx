...
import { FaWifi, FaTv, FaKey, FaCoffee, FaParking, FaSnowflake, FaShoppingBag, FaCouch, FaWater } from 'react-icons/fa';
...
export const faqItems = [
    ...
    },
    {
        ...
        description: "Giriş saat 11:00, çıkış saat 11:00'dir."
    },
    {
        icon: <FaCoffee size={28} />,
        title: "Kahvaltı hizmeti var mı?",
        description: "Kahvaltı hizmeti sağlanmamaktadır."
    },
    {
        icon: <FaParking size={28} />,
        title: "Otopark var mı?",
        description: "Misafirlerimiz için belediye tarafından sağlanan ücretli otopark hizmeti sunuluyor. Pansiyonumuzun kendisine ait otoparkı yoktur."
    },
    {
    ...
    {
        icon: <ImSpoonKnife size={28} />,
        title: "Mutfak kullanımı var mı?",
        description: "Odalarımızda mutfak bulunmamaktadır."
    },
    {
    ...
    },
    {
        ...
        description: "Mini bar odalarımızda mevcuttur."
    },
    {
        icon: <GiCoffeePot size={28} />,
        title: "Kettle var mı?",
        description: "Kettle odalarımızda mevcuttur."
    }
];